...
//           {npcProfiles.map((npc) => (
//             <div className="flex flex-col items-center" key={npc.name}>
//               <motion.img
...
//               </p>
//               {npcResponse.includes(`${npc.name}:`) && (
//                 <motion.div
//                   initial={{ opacity: 0, y: 10 }}
//                   animate={{ opacity: 1, y: 0 }}
//                   transition={{ duration: 0.4 }}
//                   className={`mt-2 p-2 text-sm bg-gray-800 ${npc.color} border rounded text-white`}
